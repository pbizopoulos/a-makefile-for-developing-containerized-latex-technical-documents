...
\begin{itemize}
	\item \textit{results} as the figures, tables and variables that are generated from a computation,
	\item \textit{results code} as the scientific-oriented programming language code (\textit{main.py}) that produces the \textit{results},
