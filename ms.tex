...
\begin{abstract}
	...
	The reproducibility of a paper can be verified locally with the use of a Makefile and remotely through a workflow that uses Virtual Machines (VMs) in the cloud.
	The verifier (author or reviewer) may execute the code that reproduces the figures, tables and variables (results) of the paper that are then used during the \LaTeX\ compilation, to produce corresponding pdf files.
