...
[![test-local-reproducibility](https://github.com/pbizopoulos/docker-as-a-development-environment-for-documenting-results/workflows/test-local-reproducibility/badge.svg)](https://github.com/pbizopoulos/docker-as-a-development-environment-for-documenting-results/actions?query=workflow%3Atest-local-reproducibility)

# Docker as a Development Environment for Documenting Results
This repository contains the code that generates **Docker as a Development Environment for Documenting Results**.
...
## Instructions
1. `git clone https://github.com/pbizopoulos/docker-as-a-development-environment-for-documenting-results`
2. `cd docker-as-a-development-environment-for-documenting-results`
