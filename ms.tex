...
\begin{figure}[!t]
	...
	\end{tikzpicture}
	\caption{In this figure the RBs template file hierarchy is depicted in the light gray background along with the flow of pdf generation.
	Blue denotes results code file, red denotes \LaTeX\ code file and dark gray background that the encapsulated files are used for a subsequent step.
	Arrows denote the data flow direction, complemented by descriptive labels.}
